...
entry test_finite_outputs (): bool =
  ...
  let output = logits 3 4 4 2 1 params [0i64, 1i64, 2i64]
...
entry test_batch_mean_loss (): bool =
  ...
  let single = next_token_loss 3 4 4 2 1 sample params
  let batched = batch_mean_loss 3 4 4 2 1 params [sample, sample]
...
entry test_micro_accumulation (): bool =
  ...
  let (full_loss, full_grad) = batch_loss_grad 3 4 4 2 1 params full
  let acc0 = zero_vector (parameter_count 3 4 4 1)
  let (loss_a, acc1) = micro_batch_loss_grad 3 4 4 2 1 4
                         acc0 params chunk_a
  let (loss_b, acc2) = micro_batch_loss_grad 3 4 4 2 1 4
                         acc1 params chunk_b
