...
| Agda | 8,528 | 34,271 | resumed 23:32 as `ft-agda` (`TIMEOUT=300 CHECK_PROCS=4 CHECK_JOBS=3`, 12 workers, `CPUWeight=300`: the long pole, ~1k units/h at 8 workers): the runs of 20:09 and 21:31 decided 1,279 units (1,132 kept, in `results.prev.nul`) | running | |
